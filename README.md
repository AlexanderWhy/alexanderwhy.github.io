...
- `assets/photo.jpg`, a portrait at roughly 4:5 (for example 800 x 1000 px). Until it exists,
  the home page shows your initials.
- `assets/job-market-paper.pdf` and other paper PDFs, then uncomment the links on the Research page.
- Replace `assets/Wang_Hongyang_CV.pdf` whenever your CV changes, keeping the same file name.
